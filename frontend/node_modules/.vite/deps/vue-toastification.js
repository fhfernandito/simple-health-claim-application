import { E as withModifiers, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qn as toRaw, Qt as resolveDynamicComponent, Sn as withCtx, St as inject, Wt as provide, Xt as resolveComponent, Yt as renderSlot, cr as normalizeStyle, dt as getCurrentInstance, et as createTextVNode, i as TransitionGroup, kt as nextTick, lr as toDisplayString, o as createApp, on as toHandlers, or as normalizeClass, q as createCommentVNode, rr as unref, rt as defineComponent, tt as createVNode } from "./vue.runtime.esm-bundler-DNw-a4Vn.js";
//#region node_modules/vue-toastification/dist/index.mjs
...
var _hoisted_34 = [/* @__PURE__ */ createBaseVNode("path", {
	fill: "currentColor",
...
function render8(_ctx, _cache) {
	...
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("div", {
			...
			key: 1,
			"toast-id": _ctx.id
		}, _ctx.hasProp(_ctx.content, "props") ? _ctx.content.props : {}, toHandlers(_ctx.hasProp(_ctx.content, "listeners") ? _ctx.content.listeners : {}), { onCloseToast: _ctx.closeToast }), null, 16, ["toast-id", "onCloseToast"]))], 10, _hoisted_16),
...
var provideToast = (options) => {
	...
	if (getCurrentInstance()) provide(toastInjectionKey, toast);
};
...
//#endregion
export { EventBus, POSITION, TYPE, createToastInterface, src_default as default, globalEventBus, provideToast, toastInjectionKey, useToast };
